...
const ContactPage = () => {
  // SVG Icon Components matching the brand style
  const Icons = {
    Phone: () => (
    ...
    Support: () => (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12a9 9 0 0 1 18 0"/><path d="M12 21a9 9 0 0 1-9-9"/><circle cx="12" cy="12" r="3"/></svg>
    )
  };
          ...
          <div className="contact-grid">
            ...
            <div className="info-card">
              ...
              <div className="contact-method">
                ...
                <div className="method-text">
                  <h4>Email Us</h4>
                  <p>support@elancotts.com</p>
                </div>
              </div>

              <div className="contact-method">
                <div className="icon-box"><Icons.MapPin /></div>
                <div className="method-text">
                  <h4>Visit Us</h4>
